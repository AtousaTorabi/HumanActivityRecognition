...
class AtousaDataset(dataset.Dataset):
    ...
    def __init__(self, which_set, nbSamples, axes = ('b', 0, 1, 'c')):
        ...
        if self.which_set =='train':
            self.data_path = '/Tmp/torabi/ImprovedfeatureHOHA2HDF/train/'
            file_n = self.data_path +'train.txt'
            self.Index=numpy.loadtxt(file_n)
            self.nbExamples = len(self.Index) - (len(self.Index) % 64)
            
        elif self.which_set =='test':
            self.data_path = '/Tmp/torabi/ImprovedfeatureHOHA2HDF/test/'
            file_n = self.data_path +'test.txt'
            self.Index=numpy.loadtxt(file_n)
            self.nbExamples = len(self.Index) - (len(self.Index) % 64)
        else :
            self.data_path = '/Tmp/torabi/ImprovedfeatureHOHA2HDF/valid/'
        ...
        file_n3 = '/Tmp/torabi/ImprovedfeatureHOHA2HDF/HOHA2Tags.txt'
