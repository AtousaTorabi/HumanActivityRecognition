...
class AtousaDataset(dataset.Dataset):
    ...
    data_path = '/Tmp/torabi/ImprovedfeatureHDF/'

    def __init__(self, which_set, nbSamples, axes = ('b', 0, 1, 'c')):
        ...
        if self.which_set =='train':
            ...
            self.data_path = '/Tmp/torabi/ImprovedfeatureHDF/train/'
            ...
            #print self.which_set
            self.data_path = '/Tmp/torabi/ImprovedfeatureHDF/test/'
        ...
        file_n3 = '/Tmp/torabi/ImprovedfeatureHDF/Tags.txt'
    ...
    def get_minibatch(self, firstIdx, lastIdx, data_specs, return_tuple):
        ...
        # reshape the matrix self.nbSamplesX427 to 427X1Xself.nbSamples
        #x = numpy.zeros(self.vidShape + [lastIdx-firstIdx,], dtype="float32")
        #y = numpy.zeros([lastIdx-firstIdx, self.nbTags],  dtype="float32")
