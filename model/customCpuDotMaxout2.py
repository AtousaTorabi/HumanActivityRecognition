...
class CpuConvMaxout(Layer):
    ...
    def set_input_space(self, space):
        ...
        self.input_space = Conv2DSpace(shape=[1,100],
        ...
        # self.input_space = Conv2DSpace(shape=output_shape,
                                          # num_channels=self.output_channels,
                                          # axes=('b', 'c', 0, 1))
        ...
        W = rng.uniform(-self.irange,self.irange,(2000, (self.num_pieces*self.output_channels)))
        W = sharedX(W)
    ...
    def fprop(self, state_below):
        ...
        state_below = state_below.dimshuffle(0,2,3,1)	
        z = self.transformer.lmul(state_below) +self.b
